Appointment. OK. @extends('admin.layouts.app')
@section('styles')
            ...
            var calendar = new Calendar(calendarEl, {
                ...
                events: [
                    @foreach ($appointments as $appointment)
                        {
                            title: '{{ $appointment->full_name }} - {{ $appointment->service_type }}',
                            start: {!! 
                                sprintf(
                                    'new Date(%d, %d, %d, %d, %d)', 
                                    Carbon\Carbon::parse($appointment->appointment_date)->year,
                                    Carbon\Carbon::parse($appointment->appointment_date)->month - 1, // Months are 0-based
                                    Carbon\Carbon::parse($appointment->appointment_date)->day,
                                    Carbon\Carbon::parse($appointment->appointment_slot)->hour,
                                    Carbon\Carbon::parse($appointment->appointment_slot)->minute
                                )
                            !!},
                            end: {!! 
                                sprintf(
                                    ...
                                    Carbon\Carbon::parse($appointment->appointment_date)->month - 1, // Months are 0-based
                                    Carbon\Carbon::parse($appointment->appointment_date)->day,
                                    Carbon\Carbon::parse($appointment->appointment_slot)->addHour()->hour,
                                    Carbon\Carbon::parse($appointment->appointment_slot)->minute
                                )
                            !!},
                            allDay: false,
