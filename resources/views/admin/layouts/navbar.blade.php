<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            {{-- <a href="#" class="btn btn-primary ml-2" data-toggle="modal" data-target="#aiAssistantModal">
                Get AI Assistant
            </a> --}}
        </li>
        {{-- <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="modal" data-target="#callModal" href="#" role="button">
